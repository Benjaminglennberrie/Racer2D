...
public class Racer2D {
    ...
    public static void setup() {
        ...
        try {
            System.out.println("Attempting to read file: " + new File("bluecar1.png").getAbsolutePath());

            player1 = ImageIO.read(new File("res/bluecar1.png"));
            //OnTrack = ImageIO.read(new File("/Users/benjaminbrodwolf/IdeaProjects/Racer2D-Benjamin-Brodwolf/src/src/rainbowroad.png"));
            OffTrack = ImageIO.read(new File("res/rainbowroad.png"));
    ...
    public static class BackgroundMusic implements Runnable {
        private String file = "res/lobbymusic.wav";
    ...
    private static class Animate implements Runnable {
        public void run() {
            ...
            while (!endgame) {
                ...
                // Clear the screen
                //g2D.clearRect(0, 0, WINWIDTH, WINHEIGHT);
                ...
                g2D.drawImage(player1, (int) p1.getX(), (int) p1.getY(), null);
...
//    }
    ...
    public static void main(String[] args) {
        ...
        BackgroundMusic menu_theme = new BackgroundMusic("res/lobbymusic.wav");
        menu_theme.play();
    }
