...
//                int LapCounter
                ...
                if (isCollidingWithGrass(p1.getX(), p1.getY(), finishline) && !hasCrossedFinishLine) {
                    lapCount += 1;
...
//            t3.start();
    ...
    public static void main(String[] args){
        ...
        src.src.RainbowRoad racer2D = new src.src.RainbowRoad();
        racer2D.setup();
...
//    private static ImageObject2 p2; // player1 and player2 racecar object
    ...
    static boolean hasCrossedFinishLine = false;
